...
const TabsList = ({ children }) => (
    <div className="flex flex-wrap gap-1 sm:gap-2 bg-white rounded-xl p-1 shadow-sm border border-indigo-100 mb-6 sm:mb-8">
        {children}
    </div>
)
...
const AdminPage = () => {
    ...
    useEffect(() => {
        const loadData = async () => {
            setLoading(true)
            await Promise.all([fetchUsuarios(), fetchCategorias(), fetchProductos()])
            setLoading(false)
        }
        loadData()
        ...
        <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
                ...
                <div className="mb-6 sm:mb-8">
                    ...
                    <p className="text-sm sm:text-base text-gray-600 mt-2">Gestiona usuarios, productos y categorías</p>
                </div>
                            ...
                            <div className="bg-white rounded-xl shadow-sm border border-indigo-100 p-4 sm:p-6">
                                ...
                                <div className="flex flex-col sm:flex-row gap-3">
                                    <div className="flex-1">
                                        <input
                                            ...
                                            className="w-full border border-indigo-200 rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                                            value={busquedaId}
                                ...
                                {usuarioBuscado && (
                                    <div className="mt-4 bg-indigo-50 border border-indigo-200 p-4 rounded-lg">
                                        <h3 className="font-semibold text-indigo-900 mb-2">Usuario encontrado:</h3>
                                ...
                                <div className="overflow-x-auto">
                                    <table className="min-w-full divide-y divide-gray-200">
                                        ...
                                        <tbody className="bg-white divide-y divide-gray-200">
                                            {usuarios.map((u) => (
                                                <tr key={u.uid} className="hover:bg-gray-50 transition-colors duration-200">
                                                    <td className="px-4 sm:px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                                        {u.nombre}
                                                    </td>
                                                    <td className="px-4 sm:px-6 py-4 whitespace-nowrap text-sm text-gray-500">{u.correo}</td>
                                                    <td className="px-4 sm:px-6 py-4 whitespace-nowrap">
                                                        <span
                                                            className={`px-2 py-1 rounded-full text-xs font-medium ${u.rol === "ADMIN_ROLE" ? "bg-red-100 text-red-800" : "bg-green-100 text-green-800"
                                                                }`}
                                                        >
                                                            {u.rol}
                                                        </span>
                                ...
                                <form onSubmit={handleBuscarProducto} className="flex flex-col sm:flex-row gap-3">
                                    <div className="flex-1 relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full border border-indigo-200 rounded-lg pl-10 pr-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                            ...
                            <div className="bg-white rounded-xl shadow-sm border border-indigo-100 p-4 sm:p-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                    <input
                                        ...
                                        className="border border-indigo-200 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                                    />
                                    <input
                                        type="text"
                                            ...
                                            {nuevoProducto.imagenes.map((img, index) => (
                                                <div key={index} className="flex gap-2">
                                                    <input
                                                        ...
                                                        className="flex-1 border border-indigo-200 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                                                    />
                                                    <button
                                                        type="button"
                                                        onClick={() => {
                                    ...
                                    {/* Sizes Section */}
                                    <div className="col-span-full">
                                        <label className="block text-sm font-semibold text-gray-900 mb-3">Talles y Stock</label>
                                        <div className="space-y-3">
                                            {nuevoProducto.talles.map((talle, index) => (
                                                <div key={index} className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                                                    <input
                                                        ...
                                                        className="border border-indigo-200 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                                                    />
                                                    <input
                                                        type="number"
                                                        placeholder="Stock"
                                                ...
                                                <tr key={p._id} className="hover:bg-gray-50 transition-colors duration-200">
                                                    <td className="px-4 sm:px-6 py-4 whitespace-nowrap">
                                                        {editandoProductoId === p._id ? (
                                                            <input
                                                                ...
                                                                className="border border-indigo-200 rounded px-2 py-1 text-sm w-full"
                                                            />
                                                        ) : (
                                                    ...
                                                    <td className="px-4 sm:px-6 py-4 whitespace-nowrap">
                                                        {editandoProductoId === p._id ? (
                                                            ...
                                                            <div className="text-sm font-semibold text-gray-900">${p.precio.toFixed(2)}</div>
                                                        )}
                                                    </td>
                                                            ...
                                                            <div className="space-y-1">
                                                                {p.talles.map((talle, index) => (
                                                                    <div key={index} className="text-xs">
                                                                        <span className="font-medium">{talle.talle}:</span>{" "}
                                                                        <span
                                                                            className={`${talle.stock > 0 ? "text-green-600" : "text-red-600"} font-medium`}
                                                                        >
                                                                            {talle.stock}
                                                                        </span>
                                                                    </div>
                                                                ...
                                                                {(productoEditado.imagenes || p.imagenes).map((img, index) => (
                                                                    <div key={index} className="flex gap-1">
                                                                        <input
                                                                            ...
                                                                            className="border rounded px-1 py-1 text-xs flex-grow"
                                                                        />
                                                                        <button
                                                                            onClick={() => {
                                                                                const nuevasImagenes = [...(productoEditado.imagenes || p.imagenes)]
                                                    ...
                                                    <td className="px-4 sm:px-6 py-4 whitespace-nowrap">
                                                        <span
                                                            className={`px-2 py-1 text-xs font-medium rounded-full ${p.activo ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"
                                                                }`}
                                                        >
                                                    ...
                                                    <td className="px-4 sm:px-6 py-4 whitespace-nowrap">
                                                        ...
                                                        >
                                                            <StarIcon
                                                                className={`w-5 h-5 ${p.destacado ? "text-yellow-500 fill-current" : "text-gray-300"}`}
                                                            />
                                                        </button>
                                                    </td>
                                                    <td className="px-4 sm:px-6 py-4 whitespace-nowrap">
                                                            ...
                                                            {editandoProductoId === p._id ? (
                                                                <>
                                                                    ...
                                                                    <button
                                                                        ...
                                                                        className="text-gray-500 hover:text-gray-700 hover:bg-gray-50 p-1 rounded transition-colors duration-200"
                                                                    >
                                                                ...
                                                                <>
                                                                    <button
                                                                        ...
                                                                        className="text-indigo-600 hover:text-indigo-800 hover:bg-indigo-50 p-1 rounded transition-colors duration-200"
                                                                    >
                            ...
                            <div className="bg-white rounded-xl shadow-sm border border-indigo-100 p-4 sm:p-6">
                                ...
                                <div className="flex flex-col sm:flex-row gap-3">
                                    <input
                                        ...
                                        className="flex-1 border border-indigo-200 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                                                    ...
                                                    <td className="px-4 sm:px-6 py-4 whitespace-nowrap">
                                                        {editandoCategoriaId === c._id ? (
                                                            <input
                                                                ...
                                                                className="border border-indigo-200 rounded-lg px-3 py-2 text-sm w-full focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                                                            />
                                                        ) : (
                                                            <div className="text-sm font-medium text-gray-900">{c.categoria}</div>
                                                        )}
                                                    </td>
                                                    <td className="px-4 sm:px-6 py-4 whitespace-nowrap">
                                                        <div className="flex gap-2">
